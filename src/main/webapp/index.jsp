...
<ul>
<li><a href="content/search/search.html" query="neo">Neo-Eldarin Word Search</a> (for beginners)</li>
<li><a href="content/search/search.html">Academic Word Search</a> (for research)</li>
<li><a href="content/search/advanced-search.html">Advanced Reference Search</a> (advanced research)</li>
<li><a href="translations/international-searches.html">International Searches</a> (non-english)</li>
</ul>
<% if ("true".equals(request.getAttribute("PUB_MODE"))) { %>
...
<a rel="license" href="http://at.boktypografen.se">http://at.boktypografen.se</a> for more information and the latest
